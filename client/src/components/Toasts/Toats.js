            ...
            <div className="toast success">
                ...
                <div className="toastDetails">
                    <span className="toastTitle">
                        {this.props.type == "Success" ? "Saving" : this.props.type == "Delete" ? "Removed" : this.props.type == "Error" ? "Wrong Credentials" : this.props.type == "Download" ? "Generating your resume.":this.props.type =="SuccessEmail" && "Account found."}
                    </span>
                    <span className="toastMessage">
                        {
                            this.props.type == "Success" ? "One moment please, we are saving your resume."
