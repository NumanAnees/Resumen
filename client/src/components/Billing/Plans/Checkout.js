...
class Checkout extends Component {
  ...
  handleSubmit = async () => {
    ...
    const res = await axios.post("https://" + conf.backendUrl + "/api/pay", {
      price:
        ...
        <div className="checkout__content-left">
          <div className="checkout__content-left-wrapper">
            ...
            <ul className="checkout__content-leftList">
              <li>
                {" "}
                <img src={CheckImage} alt="check" /> Payment through a trusted
                payment service{" "}
              </li>
              <li>
                {" "}
                <img src={CheckImage} alt="check" /> SSL Secure / 256-bit SSL
                secure checkout
              </li>
              <li>
                {" "}
                <img src={CheckImage} alt="check" /> 7-day money back guarantee
              </li>
            </ul>
            {/* Questio */}
            <div className="checkout__content-leftQuestion">
              ...
              <p>
                You can easily cancel your subscription by simply contacting our
                support team via email or telephone, or by using our contact
                page.
              </p>
            </div>
            {/* Questio */}
            ...
            {this.state.step == 0 && (
              <div className="body">
                ...
                <p className="description">
                  Please enter your country and postal code below. We collect
                  this information in order to fight against fraud and guarantee
                ...
                <PayPalButton
                  ...
                  onSuccess={async (details, data) => {
                    ...
                    const res = await axios.post(
                      "https://" + conf.backendUrl + "/api/date"
                    );
            ...
            {this.state.step == 3 && (
              <div className="body">
                <div className="paimentConfirmation">
                  <Lottie options={successOptions} height={100} width={400} />
