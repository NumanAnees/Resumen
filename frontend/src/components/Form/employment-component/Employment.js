            ...
            <div className="panel">
                <div className="panel-heading">
                    ...
                    <div className="panel-action">
                        <a onClick={() => { this.props.removeEmployment(this.props.id); this.props.removeEmploymentJsx(this.props.id) }}><img className="delete_Item" src={DeleteImage} alt="delete" /></a>
                ...
                <div className={this.state.isOpened === "false" ? "panel-body hidden" : "panel-body"}>
                    ...
                    <SimpleTextArea value={this.state.description == "" ? this.props.description : this.state.description} handleInputs={this.handleInputs} title={t("form.description")} name="Description" />
                </div>
            </div>
        )
    }
